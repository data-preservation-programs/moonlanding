...
const extractExtensionsFromSchema_js_1 = require("./extractExtensionsFromSchema.js");
/**
...
function mergeSchemas(config) {
    ...
    if (config.schemas != null) {
        for (const schema of config.schemas) {
            ...
            extractedSchemaExtensions.push((0, extractExtensionsFromSchema_js_1.extractExtensionsFromSchema)(schema));
        }
    }
