...
function extractExtensionsFromSchema(schema) {
    ...
    (0, utils_1.mapSchema)(schema, {
        ...
        [utils_1.MapperKind.FIELD]: (field, fieldName, typeName) => {
        ...
        [utils_1.MapperKind.ENUM_VALUE]: (value, typeName, _schema, valueName) => {
        ...
        [utils_1.MapperKind.INPUT_OBJECT_FIELD]: (field, fieldName, typeName) => {
            result.types[typeName].fields[fieldName] = {
                extensions: field.extensions || {},
            };
            return field;
